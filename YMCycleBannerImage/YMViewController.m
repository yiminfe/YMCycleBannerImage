...
//        bannerView.ym_maskView.hidden = YES;
//        bannerView.ym_maskView.backgroundColor = [UIColor blackColor];
//        bannerView.ym_maskView.alpha = 0.5;
//        bannerView.pageFrame = CGRectMake(100, 100, 100, 50);
//        bannerView.ym_titleLabel.frame = CGRectMake(0, 0, bannerView.bounds.size.width, 30);
//        bannerView.ym_titleLabel.backgroundColor = [UIColor blackColor];
//        bannerView.ym_titleLabel.alpha = 0.5;
//        bannerView.ym_currentPageImage = [UIImage imageNamed:@"compose_keyboard_dot_selected"];
//        bannerView.ym_pageImage = [UIImage imageNamed:@"compose_keyboard_dot_normal"];
//        bannerView.ym_titleLabel.textColor = [UIColor redColor];
//        bannerView.ym_maskView.backgroundColor = [UIColor blackColor];
//        bannerView.ym_maskView.alpha = 0.5;
...
//        bannerView.ym_currentPageIndicatorTintColor = [UIColor redColor];
    ...
    bannerView2.ym_currentPageIndicatorTintColor = [UIColor redColor];
    bannerView2.ym_pageIndicatorTintColor = [UIColor whiteColor];
